...
function Overview() {
  ...
  useEffect(() => {
    ...
    const getLatLong = (mapAddress) => {
        return mapAddress?.split(",").map((item) => parseFloat(item));   //Converts String to Float
    }
                ...
                <div className='w-full md:w-8/12'>
                    ...
                    <div className='flex flex-wrap gap-2'>
                        {reduxState?.cuisine.map((cuisineName, index)=>(
                            <span key={index} className='border border-gray-600 text-blue-600 px-2 py-1 rounded-full'>{cuisineName}</span>
                        ))}
                    </div>
                    <div className='my-4'>
                        <h4 className='text-lg font-medium'>Average Cost</h4>
                        <h6>₹{reduxState?.averageCost} for one order (approx)</h6>
                        <small className='text-gray-500'>Exclusive of apllicable taxes and charges, if any</small>
                    </div>
                    <div className='flex flex-col-reverse'>
                        ...
                        <div className='my-4'>
                            ...
                            <div>
                                <Slider {...settings}>
                                    <MenuSimilarRestaurantCard image='https://b.zmtcdn.com/data/pictures/chains/3/307893/69f1fa33c357f755f7021b7e35d59380.jpg' title='Tea' />
                                    <MenuSimilarRestaurantCard image='https://b.zmtcdn.com/data/pictures/chains/3/307893/69f1fa33c357f755f7021b7e35d59380.jpg' title='Tea' />
                                    <MenuSimilarRestaurantCard image='https://b.zmtcdn.com/data/pictures/chains/3/307893/69f1fa33c357f755f7021b7e35d59380.jpg' title='Tea' />
                                    <MenuSimilarRestaurantCard image='https://b.zmtcdn.com/data/pictures/chains/3/307893/69f1fa33c357f755f7021b7e35d59380.jpg' title='Tea' />
                                    <MenuSimilarRestaurantCard image='https://b.zmtcdn.com/data/pictures/chains/3/307893/69f1fa33c357f755f7021b7e35d59380.jpg' title='Tea' />
                        ...
                        <div className='my-4 w-full md:hidden flex flex-col gap-4'>
                            <MapView title="McDonald's" phno='+919234345634' mapLocation={getLatLong("29.077599164614135, 77.31807025811761")} address='4, Ground Floor, On Windsor Street, Vaibhav Khand, Indirapuram, Ghaziabad' />
                        </div>
                    </div>
                </div>
