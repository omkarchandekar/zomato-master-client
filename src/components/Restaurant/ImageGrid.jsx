            ...
            <div className='hidden w-full h-96 md:flex gap-1'>
                ...
                <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
                    <div className='w-full h-2/4 overflow-hidden rounded-lg'>
                        <img src={props.images.length && props.images[1].location} alt='Restaurant' className='h-full object-cover object-center rounded-lg transform transition duration-700 hover:scale-110' />
                    </div>
                    <div className='w-full h-2/4 overflow-hidden rounded-lg'>
                        <img src={props.images.length && props.images[2].location} alt='Restaurant' className='h-full object-cover object-center rounded-lg transform transition duration-700 hover:scale-110' />
                    </div>
                </div>
                <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
                    <div className='w-full h-2/4 relative'>
                        <img src={props.images.length && props.images[3].location} alt='Restaurant' className='w-full h-full object-cover rounded-lg' />
                    ...
                    <div className='w-full h-2/4 relative'>
                        <img src={props.images.length && props.images[4].location} alt='Restaurant' className='w-full h-full object-cover rounded-lg' />
                        <div className='absolute inset-0 bg-opacity-40 bg-black w-full h-full rounded-lg' />
